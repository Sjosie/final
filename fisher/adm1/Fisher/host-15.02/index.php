					...
					<ul class="tabs">
						<?php 
							...
							while ($category = mysqli_fetch_assoc($category_q)) {
								...
								?>
								<li><a href="#tabs-ts-<?php echo"$i"; ?>" data-id="<?php echo"$categoryId"; ?>"><?php echo"$categoryName"; ?></a></li>
								<?php
								$i++;
							}
					...
					<ul class="tabs">
						<?php 
							...
							while ($category = mysqli_fetch_assoc($category_q)) {
								...
								?>
								<li><a href="#tabs-er-<?php echo"$i"; ?>" data-id="<?php echo"$categoryId"; ?>"><?php echo"$categoryName"; ?></a></li>
								<?php
								$i++;
							}
