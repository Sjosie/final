...
(function (factory) {
    ...
    var dictionary = {
        ...
        ru: { days: 'Дней',   hours: 'Часов',  min: 'Мин',    sec: 'Сек' },
    ...
    $.fn.timeTo = function () {
        ...
        return this.each(function () {
            var $this = $(this);
            var data = $this.data();
            var defs, opt, i, css, language, left, ulhtml, style, dhtml1, dhtml2,
            ...
            if (!data.vals) {
                ...
                ulhtml = '<ul style="left: 1px; top:-' + data.height + 'px"><li>0</li><li>0</li></ul></div>';
                style = data.fontSize
                    ? ' style="width:' + (data.width - 4) + 'px; height:' + (data.height - 2) + 'px;"'
                    : ' style=""';
